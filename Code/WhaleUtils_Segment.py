...
def defFeatureList(freqLength, timeLength):
	...
	featureList.append("maxWhitenedMatchedFilterCorr")
	featureList.append("whitenedMatchedFilter1Corr")
	featureList.append("whitenedMatchedFilter2Corr")
	featureList.append("whitenedMatchedFilter3Corr")
	featureList.append("whitenedMatchedFilter4Corr")
	featureList.append("whitenedMatchedFilter5Corr")
	featureList.append("whitenedMatchedFilter6Corr")
	featureList.append("whitenedMatchedFilter7Corr")
	featureList.append("whitenedMatchedFilter8Corr")
	featureList.append("whitenedMatchedFilter9Corr")
	featureList.append("whitenedMatchedFilter10Corr")
	featureList.append("whitenedMatchedFilter11Corr")
	featureList.append("whitenedMatchedFilter12Corr")
	featureList.append("whitenedMatchedFilter13Corr")
	featureList.append("whitenedMatchedFilter14Corr")
	featureList.append("whitenedMatchedFilter15Corr")
	featureList.append("whitenedMatchedFilter16Corr")
	featureList.append("whitenedMatchedFilter17Corr")
	
	featureList.append("avgCorrFilterX")
	featureList.append("avgCorrFilterY")
	...
	featureList.append("segmentMinRow")
	featureList.append("segmentMaxRow")
	featureList.append("segmentMinCol")
	featureList.append("segmentMaxCol")
	featureList.append("segmentWidth")
	featureList.append("segmentLength")
	featureList.append("segmentAspect")
	featureList.append("segIntercept")
	featureList.append("segRValue")
	featureList.append("segPValue")
	featureList.append("segStdErr")
	#KMB ----------------
	
	#DRL segment derivative features
	featureList.append("maxMatchedFilterSegment")
	featureList.append("matchedFilter1Segment")
	featureList.append("matchedFilter2Segment")
	featureList.append("matchedFilter3Segment")
	featureList.append("matchedFilter4Segment")
	featureList.append("matchedFilter5Segment")
	featureList.append("matchedFilter6Segment")
	featureList.append("matchedFilter7Segment")
	featureList.append("matchedFilter8Segment")
	featureList.append("matchedFilter9Segment")
	featureList.append("matchedFilter10Segment")
	featureList.append("matchedFilter11Segment")
	featureList.append("matchedFilter12Segment")
	featureList.append("matchedFilter13Segment")
	featureList.append("matchedFilter14Segment")
	featureList.append("matchedFilter15Segment")
	featureList.append("matchedFilter16Segment")
	featureList.append("matchedFilter17Segment")
...
def generateFeatureCSV(clipInfoCSV, dataDir, baseDir, nData, frequencySlice, timeSlice, logClipping, trainCSV):
	...
	for x in range(nData):
		...
		tmpCorrFilter1 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig1, mode='same')
		tmpCorrFilter2 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig2, mode='same')
		tmpCorrFilter3 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig3, mode='same')
		tmpCorrFilter4 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig4, mode='same')
		tmpCorrFilter5 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig5, mode='same')
		tmpCorrFilter6 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig6, mode='same')
		tmpCorrFilter7 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig7, mode='same')
		tmpCorrFilter8 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig8, mode='same')
		tmpCorrFilter9 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig9, mode='same')
		tmpCorrFilter10 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig10, mode='same')
		tmpCorrFilter11 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig11, mode='same')
		tmpCorrFilter12 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig12, mode='same')
		tmpCorrFilter13 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig13, mode='same')
		tmpCorrFilter14 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig14, mode='same')
		tmpCorrFilter15 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig15, mode='same')
		tmpCorrFilter16 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig16, mode='same')
		tmpCorrFilter17 = sp.signal.convolve2d(normWhitenedSpectraSlice, sig17, mode='same')
	
		whitenedMatchedFilter1Corr = np.amax(tmpCorrFilter1)
		whitenedMatchedFilter2Corr = np.amax(tmpCorrFilter2)
		whitenedMatchedFilter3Corr = np.amax(tmpCorrFilter3)
		whitenedMatchedFilter4Corr = np.amax(tmpCorrFilter4)
		whitenedMatchedFilter5Corr = np.amax(tmpCorrFilter5)
		whitenedMatchedFilter6Corr = np.amax(tmpCorrFilter6)
		whitenedMatchedFilter7Corr = np.amax(tmpCorrFilter7)
		whitenedMatchedFilter8Corr = np.amax(tmpCorrFilter8)
		whitenedMatchedFilter9Corr = np.amax(tmpCorrFilter9)
		whitenedMatchedFilter10Corr = np.amax(tmpCorrFilter10)
		whitenedMatchedFilter11Corr = np.amax(tmpCorrFilter11)
		whitenedMatchedFilter12Corr = np.amax(tmpCorrFilter12)
		whitenedMatchedFilter13Corr = np.amax(tmpCorrFilter13)
		whitenedMatchedFilter14Corr = np.amax(tmpCorrFilter14)
		whitenedMatchedFilter15Corr = np.amax(tmpCorrFilter15)
		whitenedMatchedFilter16Corr = np.amax(tmpCorrFilter16)
		whitenedMatchedFilter17Corr = np.amax(tmpCorrFilter17)
		
		whitenedCorr1x, whitenedCorr1y = unravel_index(np.argmax(tmpCorrFilter1), shape(tmpCorrFilter1))
		whitenedCorr2x, whitenedCorr2y = unravel_index(np.argmax(tmpCorrFilter2), shape(tmpCorrFilter2))
		whitenedCorr3x, whitenedCorr3y = unravel_index(np.argmax(tmpCorrFilter3), shape(tmpCorrFilter3))
		whitenedCorr4x, whitenedCorr4y = unravel_index(np.argmax(tmpCorrFilter4), shape(tmpCorrFilter4))
		whitenedCorr5x, whitenedCorr5y = unravel_index(np.argmax(tmpCorrFilter5), shape(tmpCorrFilter5))
		whitenedCorr6x, whitenedCorr6y = unravel_index(np.argmax(tmpCorrFilter6), shape(tmpCorrFilter6))
		whitenedCorr7x, whitenedCorr7y = unravel_index(np.argmax(tmpCorrFilter7), shape(tmpCorrFilter7))
		whitenedCorr8x, whitenedCorr8y = unravel_index(np.argmax(tmpCorrFilter8), shape(tmpCorrFilter8))
		whitenedCorr9x, whitenedCorr9y = unravel_index(np.argmax(tmpCorrFilter9), shape(tmpCorrFilter9))
		whitenedCorr10x, whitenedCorr10y = unravel_index(np.argmax(tmpCorrFilter10), shape(tmpCorrFilter10))
		whitenedCorr11x, whitenedCorr11y = unravel_index(np.argmax(tmpCorrFilter11), shape(tmpCorrFilter11))
		whitenedCorr12x, whitenedCorr12y = unravel_index(np.argmax(tmpCorrFilter12), shape(tmpCorrFilter12))
		whitenedCorr13x, whitenedCorr13y = unravel_index(np.argmax(tmpCorrFilter13), shape(tmpCorrFilter13))
		whitenedCorr14x, whitenedCorr14y = unravel_index(np.argmax(tmpCorrFilter14), shape(tmpCorrFilter14))
		whitenedCorr15x, whitenedCorr15y = unravel_index(np.argmax(tmpCorrFilter15), shape(tmpCorrFilter15))
		whitenedCorr16x, whitenedCorr16y = unravel_index(np.argmax(tmpCorrFilter16), shape(tmpCorrFilter16))
		whitenedCorr17x, whitenedCorr17y = unravel_index(np.argmax(tmpCorrFilter17), shape(tmpCorrFilter17))
		...
		maxWhitenedMatchedFilterCorr = np.amax([whitenedMatchedFilter1Corr, whitenedMatchedFilter2Corr, 
										whitenedMatchedFilter3Corr, whitenedMatchedFilter4Corr, 
										whitenedMatchedFilter5Corr, whitenedMatchedFilter6Corr, 
										whitenedMatchedFilter7Corr, whitenedMatchedFilter8Corr, 
										whitenedMatchedFilter9Corr, whitenedMatchedFilter10Corr, 
										whitenedMatchedFilter11Corr, whitenedMatchedFilter12Corr, 
										whitenedMatchedFilter13Corr, whitenedMatchedFilter14Corr, 
										whitenedMatchedFilter15Corr, whitenedMatchedFilter16Corr,
										whitenedMatchedFilter17Corr])
										
		avgCorrFilterX = np.mean([matchedFilter1x, matchedFilter2x, matchedFilter3x, matchedFilter4x, 
										matchedFilter5x, matchedFilter6x, matchedFilter7x, matchedFilter8x, 
										matchedFilter9x, matchedFilter10x, matchedFilter11x, matchedFilter12x, 
										matchedFilter13x, matchedFilter14x, matchedFilter15x, matchedFilter16x,
										matchedFilter17x])
		avgCorrFilterY = np.mean([matchedFilter1y, matchedFilter2y, matchedFilter3y, matchedFilter4y, 
										matchedFilter5y, matchedFilter6y ,matchedFilter7y ,matchedFilter8y, 
										matchedFilter9y, matchedFilter10y, matchedFilter11y, matchedFilter12y, 
										matchedFilter13y, matchedFilter14y, matchedFilter15y, matchedFilter16y,
										matchedFilter17y])
		...
		#meanAndVars = timeMeans.tolist() + timeVars.tolist()
				...
				#KMB++++++++++++++++++++++++++++++
		#Here is where I start the Segmentation algorithm -kmb. You may want to play with the input image.
		inputImg=log(whitenedSpectraSlice)
		imgMin=np.min(inputImg)
		imgMax=np.max(inputImg)
		scaledImg=(inputImg-imgMin)/(imgMax-imgMin)*255
		segmentStartImg=scaledImg.astype(uint8)
	

		#Here is where the segmentation is done. The spatial and range radius matter less than the min_density. Min_density should be
		#set to something between 5 and 20. 10 worked sufficiently well for most cases
		#Error messages will be generated. Ignore
		(segmentedImg, labelsImg, numberRegions) = pms.segment(segmentStartImg, spatial_radius=1, range_radius=1, min_density=10)
	
		#It was adventageous to perform a morphological operation on the result
		processedSegmentedImg=ndimage.grey_closing(segmentedImg,  size=(3,3))

		#The next step determines which segment was the correct signal segment by using the location of the max correlation.
		#The avgMatchedFilterX &Y may not grab quite the rigth spot so it looks at the nearby region to find the max
		
		boxSize=3
		findMaxNearAvgMatchedFilterXY=processedSegmentedImg[avgMatchedFilterX-boxSize>0:avgMatchedFilterX+boxSize, avgMatchedFilterY-boxSize>0:avgMatchedFilterX+boxSize]
		localSegmentMax=np.max(findMaxNearAvgMatchedFilterXY)
		
		#Create a binary mask
		binarySegment=np.zeros(processedSegmentedImg.shape)
		binarySegment[(processedSegmentedImg == localSegmentMax)] = 1

		#Make Segmentation Metrics----
		#How big is the segment?
		signalSegmentSize =  np.sum(binarySegment)
		
		#What's the power in just the signal?
		justSignalImg=whitenedSpectraSlice*binarySegment
		justSignalPower=np.sum(justSignalImg)
		
		#What's the average signal per resolution cell?
		avgSignalPower = justSignalPower/signalSegmentSize
		

		#What's the power of the non-signal? 
		inverseBinarySegment=binarySegment+1
		inverseBinarySegment[(inverseBinarySegment == 2)] = 0
		
		justNonSignalImg=whitenedSpectraSlice*inverseBinarySegment
		justNonSignalPower=np.sum(justNonSignalImg)
		
		avgNonSignalPower = justNonSignalPower/np.sum(inverseBinarySegment)
		
		totalSNR = justSignalPower / justNonSignalPower
		invTotalSNR=1.0/totalSNR
		
		avgSNR = avgSignalPower / avgNonSignalPower
		invAvgSNR=1.0/avgSNR
		
		#Here's where I calculate some shape information about the segment
		sparseSegment=coo_matrix(binarySegment)
		segmentRows = sparseSegment.row
		segmentCols = sparseSegment.col
		segmentMinRow = np.min(segmentRows)
		segmentMaxRow = np.max(segmentRows)
		segmentMinCol = np.min(segmentCols)
		segmentMaxCol = np.max(segmentCols)
		segmentWidth = segmentMaxCol-segmentMinCol+1
		segmentLength = segmentMaxRow-segmentMinRow+1
		segmentAspect = segmentWidth.astype(float)/segmentLength.astype(float)
		centerY=binarySegment.shape[0]/2.0
		centerX=binarySegment.shape[1]/2.0
		segmentLineX=segmentCols.astype(float)-centerX
		segmentLineY=segmentRows.astype(float)-centerY
		segmentCenterY=binarySegment.shape[0]/2.0
		segmentCenterX=binarySegment.shape[1]/2.0
		segmentLineX=segmentCols.astype(float)-segmentCenterX
		segmentLineY=segmentRows.astype(float)-segmentCenterY
		segSlope, segIntercept, segRValue, segPValue, segStdErr = stats.linregress(segmentLineX,segmentLineY)
		
		#calculate matched filter outputs on segment
		matchedFilter1Segent = np.amax(sp.signal.convolve2d(binarySegment, sig1, mode='same')) - sig1TranslationConst
		matchedFilter2Segent = np.amax(sp.signal.convolve2d(binarySegment, sig2, mode='same')) - sig2TranslationConst
		matchedFilter3Segent = np.amax(sp.signal.convolve2d(binarySegment, sig3, mode='same')) - sig3TranslationConst
		matchedFilter4Segent = np.amax(sp.signal.convolve2d(binarySegment, sig4, mode='same')) - sig4TranslationConst
		matchedFilter5Segent = np.amax(sp.signal.convolve2d(binarySegment, sig5, mode='same')) - sig5TranslationConst
		matchedFilter6Segent = np.amax(sp.signal.convolve2d(binarySegment, sig6, mode='same')) - sig6TranslationConst
		matchedFilter7Segent = np.amax(sp.signal.convolve2d(binarySegment, sig7, mode='same')) - sig7TranslationConst
		matchedFilter8Segent = np.amax(sp.signal.convolve2d(binarySegment, sig8, mode='same')) - sig8TranslationConst
		matchedFilter9Segent = np.amax(sp.signal.convolve2d(binarySegment, sig9, mode='same')) - sig9TranslationConst
		matchedFilter10Segent = np.amax(sp.signal.convolve2d(binarySegment, sig10, mode='same')) - sig10TranslationConst
		matchedFilter11Segent = np.amax(sp.signal.convolve2d(binarySegment, sig11, mode='same')) - sig11TranslationConst
		matchedFilter12Segent = np.amax(sp.signal.convolve2d(binarySegment, sig12, mode='same')) - sig12TranslationConst
		matchedFilter13Segent = np.amax(sp.signal.convolve2d(binarySegment, sig13, mode='same')) - sig13TranslationConst
		matchedFilter14Segent = np.amax(sp.signal.convolve2d(binarySegment, sig14, mode='same')) - sig14TranslationConst
		matchedFilter15Segent = np.amax(sp.signal.convolve2d(binarySegment, sig15, mode='same')) - sig15TranslationConst
		matchedFilter16Segent = np.amax(sp.signal.convolve2d(binarySegment, sig16, mode='same')) - sig16TranslationConst
		matchedFilter17Segent = np.amax(sp.signal.convolve2d(binarySegment, sig17, mode='same')) - sig17TranslationConst
		
		maxMatchedFilterSegment = np.amax([matchedFilter1Segent, matchedFilter2Segent, matchedFilter3Segent,
											matchedFilter4Segent, matchedFilter5Segent, matchedFilter6Segent,
											matchedFilter7Segent, matchedFilter8Segent, matchedFilter9Segent,
											matchedFilter10Segent, matchedFilter11Segent, matchedFilter12Segent,
											matchedFilter13Segent, matchedFilter14Segent, matchedFilter15Segent,
											matchedFilter16Segent, matchedFilter17Segent])	
		...
		featureArray = [maxMatchedFilter, matchedFilter1, matchedFilter2, matchedFilter3, 
						...
						maxWhitenedMatchedFilterCorr, 
						whitenedMatchedFilter1Corr, whitenedMatchedFilter2Corr, 
						whitenedMatchedFilter3Corr, whitenedMatchedFilter4Corr, 
						whitenedMatchedFilter5Corr, whitenedMatchedFilter6Corr, 
						whitenedMatchedFilter7Corr, whitenedMatchedFilter8Corr, 
						whitenedMatchedFilter9Corr, whitenedMatchedFilter10Corr, 
						...
						#kmb 4/6
						segmentMinRow, segmentMaxRow, segmentMinCol, segmentMaxCol, segmentWidth, segmentLength, segmentAspect, segIntercept, segRValue, segPValue, segStdErr,	
						
						maxMatchedFilterSegment,
						matchedFilter1Segent, matchedFilter2Segent, matchedFilter3Segent,
						matchedFilter4Segent, matchedFilter5Segent, matchedFilter6Segent,
						matchedFilter7Segent, matchedFilter8Segent, matchedFilter9Segent,
						matchedFilter10Segent, matchedFilter11Segent, matchedFilter12Segent,
						matchedFilter13Segent, matchedFilter14Segent, matchedFilter15Segent,
